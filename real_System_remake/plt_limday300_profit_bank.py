...
mlp_seed_cols = ["MLP_891_bank_profit", "MLP_981_bank_profit", "MLP_936_bank_profit"]
trans_seed_cols = ["tf_936_bank_profit", "tf_981_bank_profit", "tf_891_bank_profit"]
...
plt.fill_between(df["step"], lower1, upper1, color="C0", alpha=0.15)
...
plt.fill_between(df["step"], lower2, upper2, color="C1", alpha=0.15)
